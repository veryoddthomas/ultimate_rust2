...
//! applied to round, orange-colored squash varieties, though it does not possess a scientific
//! definition and may be used in reference to many different squashes of varied appearance.
//! ![alt text](https://upload.wikimedia.org/wikipedia/commons/thumb/5/5c/FrenchMarketPumpkinsB.jpg/700px-FrenchMarketPumpkinsB.jpg)
...
// Challenge: Find the option to pass to `cargo doc` so that documentation for this
// private item gets generated as well.
// Hint: `cargo doc -h` will show you all the relevant options.
